          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" value="{{ $recruitment->location }}" placeholder="Enter job location" required>
              </div>
              @error('location')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input type="date" name="deadline" id="deadline" class="form-control @error('deadline') is-invalid @enderror" value="{{ $recruitment->deadline }}" required>
              </div>
              @error('deadline')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror
