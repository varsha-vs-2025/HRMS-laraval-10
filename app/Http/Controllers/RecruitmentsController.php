...
class RecruitmentsController extends Controller
{
    ...
    {
        $recruitments = Recruitment::all(); // Fetch all recruitments
   ...
   public function store(StoreRecruitmentRequest $request)
{
    $createArray = [
        ...
        'location' => $request->input('location'),   // ✅ NEW
        'deadline' => $request->input('deadline'),   // ✅ NEW
    ];
    ...
    return redirect()->route('recruitments.index')->with('status', 'Successfully created a recruitment.');
}
   ...
   public function update(StoreRecruitmentRequest $request, Recruitment $recruitment)
{
    ...
    return redirect()->route('recruitments.index')->with('status', 'Successfully updated.');
}
    ...
    public function destroy(Recruitment $recruitment)
    {
        ...
        return redirect()->route('recruitments.index')->with('status', 'Successfully deleted recruitment.');
    }
